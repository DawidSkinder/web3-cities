...
export const CRYPTO_CITY_PRESETS: Record<CryptoCityMode, CryptoCityPreset> = {
  ...
  sol: {
    ...
    theme: {
      ...
      traceWarm: '#f3f7ff',
      tracePale: '#6bf0d8',
      groundGlowCenter: '#9df8e6',
      groundGlowCenterHot: '#d6fff5',
      groundGlowRing: '#38d6b4',
      groundGlowRingHot: '#a455ff',
      groundGridMajor: '#8de7d6',
      groundGridMinor: '#689db6',
      groundWindDiag: '#b7f5f0',
      groundWindAxisPrimary: '#9cf3ea',
      groundWindAxisSecondary: '#14f195',
      groundWindCross: '#f0fffe',
      groundArteryPrimary: '#14f195',
      groundArterySecondary: '#c8c7ff',
      groundArteryTertiary: '#7df0df',
      shockwavePositive: '#4dffc0',
      shockwaveNegative: '#9f73ff',
      districtBase: '#d7fff1',
      districtAccent: '#8fe9ff',
      hudAccentRgb: '20,241,149',
      labelTextPrimary: '#f5fffd',
      labelTextSecondary: '#c8fff1',
      labelTextMuted: '#d9f7ff',
      mountainFarCore: '#2a1b4f',
      mountainFarShoulder: '#20153f',
      mountainFarFoothill: '#161131',
      mountainMidCore: '#3a246a',
      mountainMidShoulder: '#2e1d56',
      mountainMidFoothill: '#221744',
      mountainPeakCore: '#57339a',
      mountainPeakShoulder: '#412674',
      mountainPeakFoothill: '#2d1b52',
      treeGlowLow: '#9cf3ea',
      treeGlowHigh: '#14f195',
      beaconOuter: '#14f195',
      beaconInner: '#d9fff2'
