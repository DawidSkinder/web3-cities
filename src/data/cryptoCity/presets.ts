...
export const CRYPTO_CITY_PRESETS: Record<CryptoCityMode, CryptoCityPreset> = {
  ...
  bnb: {
    ...
    theme: {
      ...
      mountainFarCore: '#2f2507',
      mountainFarShoulder: '#241c05',
      mountainFarFoothill: '#181303',
      mountainMidCore: '#49380b',
      mountainMidShoulder: '#392c09',
      mountainMidFoothill: '#2a2106',
      mountainPeakCore: '#6a520f',
      mountainPeakShoulder: '#523f0c',
      mountainPeakFoothill: '#3a2d08',
      treeGlowLow: '#fff1a4',
      treeGlowHigh: '#f3d01b',
      beaconOuter: '#f3d01b',
      beaconInner: '#fff6c8'
  ...
  xrp: {
    ...
    theme: {
      ...
      mountainFarCore: '#1b1f28',
      mountainFarShoulder: '#151922',
      mountainFarFoothill: '#0f131a',
      mountainMidCore: '#272d39',
      mountainMidShoulder: '#1f2530',
      mountainMidFoothill: '#171c25',
      mountainPeakCore: '#373f4f',
      mountainPeakShoulder: '#2b3240',
      mountainPeakFoothill: '#202632',
      treeGlowLow: '#f3f5fa',
      treeGlowHigh: '#d7dbe5',
      beaconOuter: '#f4f6fb',
      beaconInner: '#ffffff'
  ...
  lunc: {
    ...
    theme: {
      ...
      mountainFarCore: '#0b2346',
      mountainFarShoulder: '#081b37',
      mountainFarFoothill: '#061327',
      mountainMidCore: '#12376f',
      mountainMidShoulder: '#0d2b57',
      mountainMidFoothill: '#0a2041',
      mountainPeakCore: '#1a4d9c',
      mountainPeakShoulder: '#133d7b',
      mountainPeakFoothill: '#0d2c59',
      treeGlowLow: '#a9d8ff',
      treeGlowHigh: '#37a3ff',
      beaconOuter: '#37a3ff',
      beaconInner: '#dff2ff'
