...
export const CRYPTO_CITY_PRESETS: Record<CryptoCityMode, CryptoCityPreset> = {
  ...
  sol: {
    ...
    theme: {
      ...
      mountainFarCore: '#23103f',
      mountainFarShoulder: '#190b31',
      mountainFarFoothill: '#110722',
      mountainMidCore: '#34155c',
      mountainMidShoulder: '#281047',
      mountainMidFoothill: '#1c0b34',
      mountainPeakCore: '#5d25a8',
      mountainPeakShoulder: '#461c7f',
      mountainPeakFoothill: '#2d1150',
      treeGlowLow: '#a8fff0',
      treeGlowHigh: '#14f195',
      beaconOuter: '#14f195',
      beaconInner: '#d7fff4'
